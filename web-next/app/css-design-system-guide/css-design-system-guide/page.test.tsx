...
describe("css-design-system-guide page", () => {
  ...
  it("Mermaid 図 11 個・table 9 個・コードブロック 20 個を描画する", () => {
    const { container } = render(<Page />);
    expect(container.querySelectorAll(".mermaid")).toHaveLength(11);
  ...
  it("globals.css に .css-design-system-guide .main のレイアウト調整が含まれている", () => {
    ...
    expect(mainStyleRegex.test(section)).toBe(true);
  });
});
