...
export const metadata = {
  title: "AI-Native Value Architect Certification 学習ガイド",
  description:
...
AVA["AI Value Architect"]:::hub
ART["Agile Release Train (ART)"]:::box
TEAMS["複数のAgileチーム"]:::box
RTE["Release Train Engineer"]:::box
BIZ["Business Owner / エグゼクティブ"]:::box
ENG["エンジニアリング / AI開発者"]:::box
AVA -->|"コーチング・整合"| ART
ART --> TEAMS
ART --> RTE
AVA -->|"ビジネス言語で橋渡し"| BIZ
...
classDef hub fill:#FAF1DF,stroke:#B8802A,color:#161B26;
classDef done fill:#EAF4EC,stroke:#2F6B3D,color:#161B26;
D1["Unready Data(データ未整備)"]:::box
D2["Unplanned Operations(運用未計画)"]:::box
D3["Unbounded Risk(リスク無制限)"]:::box
D4["Unengineered Adoption(定着未設計)"]:::box
D5["Unmeasured Value(価値未測定)"]:::box
GY["POC Graveyard"]:::hub
FF["Feasibility Filtersで着手前に検知"]:::box
SCALE["スケールされた本番価値"]:::done
D1 --> GY
D2 --> GY
D3 --> GY
D4 --> GY
...
classDef hub fill:#FAF1DF,stroke:#B8802A,color:#161B26;
classDef done fill:#EAF4EC,stroke:#2F6B3D,color:#161B26;
A["Audit: 既存AI資産の棚卸し"]:::box
B["Activate: 機能の有効化"]:::box
C["Optimize: ワークフローへの組み込み"]:::hub
D["Centralize: 組織全体への標準化"]:::done
A --> B
B --> C
C --> D
D -->|"継続的フィードバック"| A`;
...
classDef hub fill:#FAF1DF,stroke:#B8802A,color:#161B26;
classDef done fill:#EAF4EC,stroke:#2F6B3D,color:#161B26;
Q1{"ナレッジは頻繁に更新されるか"}:::hub
Q2{"クエリ量は非常に多いか"}:::hub
Q3{"出力形式・トーンの厳密な統一が必要か"}:::hub
RAG["RAGを選択"]:::box
FT["Fine-Tuningを選択"]:::box
HYB["ハイブリッド(RAG + Fine-Tuning)"]:::done
RAGFINAL["RAGのみで運用"]:::done
Q1 -->|"はい"| RAG
Q1 -->|"いいえ"| Q2
Q2 -->|"多い"| FT
Q2 -->|"多くない"| RAG
...
classDef done fill:#EAF4EC,stroke:#2F6B3D,color:#161B26;
S["Sense: シグナルの察知"]:::box
DI["Discover: 機会の探索"]:::box
DE["Design: ソリューション設計"]:::hub
DL["Deliver: 本番化・展開"]:::done
S --> DI
DI --> DE
DE --> DL
DL -->|"学びを次のサイクルへ還元"| S`;
...
classDef hub fill:#FAF1DF,stroke:#B8802A,color:#161B26;
classDef done fill:#EAF4EC,stroke:#2F6B3D,color:#161B26;
ROLE["AI Value Architect"]:::hub
RESP["5つの責任領域"]:::box
LIFECYCLE["AI-Native Solution Lifecycle"]:::box
PLAYBOOK["Value Maximizer Playbook"]:::box
ARTIFACTS["コアアーティファクト"]:::box
STORY["AI-Powered Storytelling"]:::box
OUTCOME["スケールされた組織的価値"]:::done
ROLE --> RESP
ROLE --> LIFECYCLE
ROLE --> PLAYBOOK
RESP --> LIFECYCLE
...
export default function AiNativeValueArchitectPage() {
  return (
    <div className="ai-native-value-architect-guide">
      <div className="layout">
        <AiNativeValueArchitectSidebar />

        <main className="main">
          <h1>AI-Native Value Architect Certification 学習ガイド</h1>
          <p className="hero-sub">
            Scaled Agile, Inc.
            が提供する認定資格を、初学者向けにステップバイステップで解説する非公式の学習資料です。
          </p>
          ...
          <div className="disclaimer">
            <strong>免責事項:</strong> 本ガイドはScaled Agile, Inc.
            の公式教材ではない、非公式の学習補助資料です。主要な主張には可能な範囲で一次情報源（公式ページ・公式サポート記事・認定トレーニングパートナーの公開ページ）を付記していますが、すべての項目に一次情報源が付いているわけではありません。試験の詳細・料金体系・出題比率は変更される可能性があるため、受験前に必ず
            <Ext href="https://scaledagile.com/certification/ai-native-value-architect/">
              公式サイト
            </Ext>
            および
            <Ext href="https://www.scaledagile.com/certification/candidate-agreement/">
              Candidate Agreement
            </Ext>
            の最新の記載を確認してください。図解はすべてMermaid、比較・整理はすべてMarkdown表記のHTML表で統一し、ASCIIアートは使用していません。
          </div>

          <section className="section" id="prereq">
            <h2>0. 前提知識のおさらい</h2>
            <p>
              このガイドは、SAFe（Scaled Agile Framework）やAgile Release
              Train（ART）の基礎用語をある程度知っている方を主な対象にしていますが、初学者でも迷わないよう最低限の前提知識を先に整理しておきます。
            </p>
            <table>
              <thead>
                <tr>
              ...
              <tbody>
                <tr>
                  <td>SAFe</td>
                  <td>大規模組織で複数チームのAgile開発を同期させるためのフレームワーク</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>ARTのプロセスを回すサーバントリーダー（ScrumMasterのART版）</td>
                </tr>
                <tr>
                  <td>SPC（SAFe Practice Consultant）</td>
                  <td>組織へのSAFe導入を支援する社内外のコンサルタント／トレーナー</td>
                </tr>
                <tr>
                  <td>Business Owner</td>
                  <td>ARTが生み出す価値に責任を持つ経営層側のステークホルダー</td>
                </tr>
              </tbody>
            </table>
            <p>
          ...
          <section className="section" id="overview">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>認定名</td>
                  <td>Certified AI-Native Value Architect</td>
                </tr>
                <tr>
                  <td>提供元</td>
                  <td>Scaled Agile, Inc.（SAFeの開発元）</td>
                </tr>
                <tr>
                  <td>前提条件</td>
                  <td>なし（None required）</td>
                </tr>
                <tr>
                  <td>研修時間</td>
                  <td>
            ...
            <div className="callout source">
              ...
              <p>
                <Ext href="https://scaledagile.com/certification/ai-native-value-architect/">
                  AI-Native Value Architect Certification（Scaled Agile公式）
                </Ext>
                、
                <Ext href="https://www.cprime.com/learning/courses/ai-native-value-architect/">
                  AI-Native Value Architect（Cprime, 認定トレーニングパートナー）
                </Ext>
              </p>
            </div>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>出題形式</td>
                  <td>多肢選択・単一選択（multiple choice, single select）</td>
                </tr>
                <tr>
                  <td>受験形式</td>
                  <td>Web受験、クローズドブック、外部支援不可</td>
                </tr>
                <tr>
                  <td>受験機会</td>
                  <td>コース修了後、Learning Plan経由でアクセス可能</td>
                </tr>
                <tr>
                  <td>初回受験料</td>
                  <td>コース修了後60日以内であれば研修費用に含まれる</td>
                </tr>
                <tr>
                  <td>再受験料</td>
                  <td>$50</td>
            ...
            <div className="callout source">
              ...
              <p>
                <Ext href="https://ai-native-support.scaledagile.com/en/articles/16504256-exam-details-ai-native-value-architect-exam-ai-native-value-architect">
                  Exam Details: AI-Native Value Architect Exam（Scaled Agile公式サポート）
                </Ext>
              </p>
            </div>
            <div className="callout practice">
            ...
            <div className="diagram-wrap">
              <div className="mermaid-target">
                <MermaidDiagram chart={DIAGRAM_PIE} />
              </div>
              <div className="diagram-caption">図1: 試験ドメイン別 出題比率</div>
            </div>
          ...
          <section className="section" id="role">
            <h2>2. AI Value Architectとは何か</h2>
            ...
            <div className="callout source">
              ...
              <p>
                <Ext href="https://framework.scaledagile.com/ain-safe-ai-value-architect">
                  AI Value Architect（Scaled Agile Framework公式）
                </Ext>
              </p>
            </div>
            <p>
            ...
            <p>
              技術チームと経営層の間の分断を終わらせ、施策を「POCグレイブヤード」からスケールされた持続的な価値へと導く存在と位置づけられています。
            </p>
            <div className="callout source">
              <div className="callout-label">
                <IconExternalLink size={16} />
            ...
            <div className="diagram-wrap">
              <div className="mermaid-target">
                <MermaidDiagram chart={DIAGRAM_ART} />
              </div>
              <div className="diagram-caption">図2: ART上でのAI Value Architectの位置づけ</div>
            </div>
            ...
            <div className="callout source">
              ...
              <p>
                <Ext href="https://www.prnewswire.com/news-releases/scaled-agile-releases-ai-native-safe-a-new-version-of-the-worlds-most-trusted-framework-to-provide-governance-for-the-ai-era-302807369.html">
                  Scaled Agile Releases AI-Native SAFe（PR Newswire）
                </Ext>
              </p>
            </div>

            <h3>2.3 対象者（候補となる既存の役割）</h3>
            <table>
              <thead>
                <tr>
                  <th>既存の役割</th>
                  <th>AI Value Architectとして活きる強み</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>Scrum Master / Team Coach</td>
                  <td>チームのファシリテーション経験、障害物除去の習慣</td>
                </tr>
                <tr>
                  <td>SAFe Practice Consultant (SPC)</td>
                  <td>組織変革・SAFe導入の視点、複数チーム横断の調整力</td>
                </tr>
                <tr>
                  <td>Release Train Engineer (RTE)</td>
                  <td>ART全体のシステム思考、複数ステークホルダーの同期経験</td>
                </tr>
                <tr>
                  <td>System Architect</td>
                  <td>技術的実現可能性の判断力、アーキテクチャ全体を俯瞰する視点</td>
                </tr>
                <tr>
                  <td>Product Manager / Product Owner</td>
                  <td>ビジネス価値の定義力、優先順位付けの経験</td>
                </tr>
              </tbody>
            </table>
            <p>
            ...
            <div className="callout source">
              ...
              <p>
                ...
                <Ext href="https://www.gladwellacademy.com/knowledge/blogs/what-is-an-ai-value-architect">
                  What is an AI Value Architect? Role &amp; Skills（Gladwell Academy, 第三者要約）
                </Ext>
              </p>
            </div>
            <div className="callout practice">
          ...
          <section className="section" id="domain1">
            <h2>3. ドメイン1: Developing the AI-Native Change Agent（28–32%）</h2>
            ...
            <h3>3.1 5つの失敗モード（Five Failure Modes）</h3>
            <p>
              AIパイロットが本番運用に届かず「POCグレイブヤード」に沈む原因は、偶然ではなく典型的な5つの失敗モードに整理できます。
            </p>
            <table>
              <thead>
                <tr>
                  <th>失敗モード</th>
                  <th>症状</th>
                  <th>Value Architectの対応</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>
                    <strong>Unready Data</strong>（データ未整備）
                  </td>
                  <td>学習・検索対象のデータが散在・非構造化・品質不十分</td>
                  <td>データオーナーを早期に特定し、データ品質基準を合意する</td>
                </tr>
                <tr>
                  <td>
                    <strong>Unplanned Operations</strong>（運用未計画）
                  </td>
                  <td>本番稼働後の監視・再学習・障害対応の設計がない</td>
                  <td>MLOps/運用体制をDesignフェーズの成果物に含める</td>
                </tr>
                <tr>
                  <td>
                    <strong>Unbounded Risk</strong>（リスク無制限）
                  </td>
                  <td>セキュリティ・コンプライアンス・倫理面の許容範囲が未定義</td>
                  <td>Feasibility Filtersでリスクの境界を事前に明文化する</td>
                </tr>
                <tr>
                  <td>
                    <strong>Unengineered Adoption</strong>（定着未設計）
                  </td>
                  <td>ツールは配布されたが、業務フローへの組み込みや変更管理がない</td>
                  <td>チェンジマネジメント計画をSolution Charterに組み込む</td>
                </tr>
                <tr>
                  <td>
                    <strong>Unmeasured Value</strong>（価値未測定）
                  </td>
                  <td>成功の定義・測定指標がないため、投資判断ができない</td>
                  <td>着手前にベースライン指標とターゲットを合意する</td>
                </tr>
              </tbody>
            </table>
            ...
            <div className="diagram-wrap">
              <div className="mermaid-target">
                <MermaidDiagram chart={DIAGRAM_FAILURE} />
              </div>
              <div className="diagram-caption">図3: 5つの失敗モードとPOCグレイブヤード</div>
            </div>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>データ準備度フィルタ</td>
                  <td>必要なデータは十分な品質・アクセス性で存在するか</td>
                  <td>Unready Data</td>
                </tr>
                <tr>
                  <td>運用準備度フィルタ</td>
                  <td>本番運用後の監視・保守を誰がどう行うか定義されているか</td>
                  <td>Unplanned Operations</td>
                </tr>
                <tr>
                  <td>リスク境界フィルタ</td>
                  <td>セキュリティ・コンプライアンス・倫理上の許容範囲は明文化されているか</td>
                  <td>Unbounded Risk</td>
                </tr>
                <tr>
                  <td>定着可能性フィルタ</td>
                  <td>利用者の業務フローに組み込むための変更管理計画があるか</td>
                  <td>Unengineered Adoption</td>
                </tr>
                <tr>
                  <td>価値測定フィルタ</td>
                  <td>成功の定義と測定指標が着手前に合意されているか</td>
                  <td>Unmeasured Value</td>
                </tr>
              </tbody>
            </table>
            <div className="callout practice">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>プロンプト／AIリテラシー</td>
                  <td>主要なAIツールの得意・不得意の把握、出力の検証方法</td>
                </tr>
                <tr>
                  <td>データリテラシー</td>
                  <td>データ品質・バイアス・プライバシーの基本的な評価眼</td>
                </tr>
                <tr>
                  <td>リスク／ガバナンスリテラシー</td>
                  <td>社内ポリシーや外部規制（第4章参照）の基本理解</td>
                </tr>
                <tr>
                  <td>ファシリテーションスキル</td>
                  <td>対立する意見を持つステークホルダーの合意形成技術</td>
                </tr>
                <tr>
                  <td>ストーリーテリングスキル</td>
                  <td>技術的な成果を経営層向けの言葉に翻訳する技術（第6章参照）</td>
                </tr>
              </tbody>
            </table>
            <div className="callout practice">
              ...
              <ul>
                <li>
                  5つのスキル領域を毎四半期ごとに自己評価し、最も弱い1領域に学習時間を集中させる。全方位を同時に伸ばそうとすると停滞しやすい。
                </li>
              </ul>
            </div>
          ...
          <section className="section" id="domain2">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>
                    <strong>Audit（監査）</strong>
                  </td>
                  <td>組織が既に保有するAIツール・機能の棚卸し</td>
                  <td>契約中のSaaSに含まれるAI機能の一覧化、利用率の可視化</td>
                </tr>
                <tr>
                  <td>
                    <strong>Activate（活性化）</strong>
                  </td>
                  <td>眠っている機能を実際に有効化する</td>
                  <td>管理者設定の見直し、パイロットユーザーへのオンボーディング</td>
                </tr>
                <tr>
                  <td>
                    <strong>Optimize（最適化）</strong>
                  </td>
                  <td>実際の業務ワークフローに組み込む</td>
                  <td>既存プロセスの再設計、成果指標のモニタリング</td>
                </tr>
                <tr>
                  <td>
                    <strong>Centralize（標準化）</strong>
                  </td>
                  <td>成功パターンをART全体・組織全体に展開する</td>
                  <td>ベストプラクティスの文書化、ガバナンスへの組み込み</td>
                </tr>
              </tbody>
            </table>
            ...
            <div className="diagram-wrap">
              <div className="mermaid-target">
                <MermaidDiagram chart={DIAGRAM_PLAYBOOK} />
              </div>
              <div className="diagram-caption">図4: Value Maximizer Playbookの4段階サイクル</div>
            </div>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>初期コスト</td>
                  <td>低い（モデル訓練が不要）</td>
                  <td>高い（データ準備・訓練計算資源が必要）</td>
                </tr>
                <tr>
                  <td>コスト構造</td>
                  <td>クエリごとの従量課金（コンテキスト投入コストが累積）</td>
                  <td>訓練時に前払い、以降は単価が比較的安定</td>
                </tr>
                <tr>
                  <td>知識更新の速さ</td>
                  <td>データを差し替えるだけで即時反映</td>
                  <td>再訓練が必要なため更新に時間がかかる</td>
                </tr>
                <tr>
                  <td>出典の明示</td>
                  <td>検索元を引用できる</td>
                  <td>内部化された知識のため出典を示しにくい</td>
                </tr>
                <tr>
                  <td>向いている場面</td>
                  <td>知識が頻繁に変化する／大量多様な文書がある／迅速な立ち上げが必要</td>
                  <td>クエリ量が非常に多い／出力形式やトーンの厳密な統一が必要</td>
                </tr>
                <tr>
                  <td>大量トラフィック時のコスト傾向</td>
                  <td>コンテキスト投入コストが積み上がり高額化しうる</td>
                  <td>一件あたりの限界費用が安定し、量が増えるほど有利になりやすい</td>
                </tr>
              </tbody>
            </table>
            ...
            <div className="diagram-wrap">
              <div className="mermaid-target">
                <MermaidDiagram chart={DIAGRAM_RAGFT} />
              </div>
              <div className="diagram-caption">図5: RAG vs Fine-Tuning 意思決定フロー</div>
            </div>
            ...
            <div className="callout note">
              ...
              <p>
                この比較表は、RAGとFine-Tuningを扱う複数の実務者向け解説記事（下記ソース）が概ね共通して示している一般的な傾向を整理したものであり、単一の公式ベンチマークや学術的な定量比較に基づくものではありません。実際のコスト優位性は、利用するモデル・クエリ量・データ量・インフラ構成によって変動します。自社での意思決定には、必ず自社のユースケースでの試算・検証を行ってください。
              </p>
            </div>
            <div className="callout source">
              <div className="callout-label">
              ...
              <p>
                <Ext href="https://www.actian.com/blog/databases/should-you-use-rag-or-fine-tune-your-llm/">
                  Should You Use RAG or Fine-Tune Your LLM?（Actian）
                </Ext>
                、
                <Ext href="https://winder.ai/rag-vs-fine-tuning-2026-decision-framework/">
            ...
            <div className="callout practice">
              ...
              <ul>
                <li>
                  経営層への説明では「RAGは月額課金型、Fine-Tuningは先行投資型」という家計・投資の例えに置き換えると理解が早い。
                </li>
                <li>
                  「どちらが優れているか」ではなく「クエリ量・知識の変化頻度・出典明示の必要性」という3変数で意思決定する、という枠組み自体を共有する。
                </li>
                <li>
                  多くの実務者は「まずRAGをデフォルトにし、コスト・品質上の明確な理由があるときだけFine-Tuningやハイブリッドを検討する」という進め方を推奨している。最初からFine-Tuningに飛びつくのはアンチパターン。
                </li>
              </ul>
            </div>

            <h3>4.3 ステークホルダーの整合性とコンフリクトマネジメント</h3>
            <div className="callout practice">
              <div className="callout-label">
                <IconBulb size={16} />
                ベストプラクティス
            ...
            <div className="callout practice">
              ...
              <ul>
                <li>
                  AI施策特有のリスク（モデルドリフト、ハルシネーション、データ漏洩など）は従来のソフトウェア開発のリスクと性質が異なるため、既存のリスク登録簿の項目をそのまま流用せず、AI特有のリスクカテゴリを追加する。
                </li>
                <li>
                  計画は一度で確定させず、Sense/Discover/Design/Deliverの各節目（第5章）で見直す前提で設計する。
                </li>
              </ul>
            </div>

            <h3>4.5 投資ケースとガバナンス</h3>
            <p>
              AI施策のガバナンスを検討する際は、社内独自の基準だけでなく、外部の公的フレームワークを参照するのがベストプラクティスです。代表的なものが米国NISTの
              <strong>AI Risk Management Framework (AI RMF)</strong>
              で、Govern・Map・Measure・Manageの4機能でAIリスクを管理する考え方を提供しています。
            </p>
            <div className="callout source">
              <div className="callout-label">
                <IconExternalLink size={16} />
              ...
              <p>
                <Ext href="https://www.nist.gov/itl/ai-risk-management-framework">
                  AI Risk Management Framework（NIST公式）
                </Ext>
              </p>
            </div>
            <div className="callout practice">
          ...
          <section className="section" id="domain3">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>
                    <strong>Sense（察知）</strong>
                  </td>
                  <td>機会や課題の兆候を捉える</td>
                  <td>現場の困りごとのヒアリング、既存データ・ツールの棚卸し</td>
                  <td>課題仮説</td>
                </tr>
                <tr>
                  <td>
                    <strong>Discover（探索）</strong>
                  </td>
                  <td>機会を掘り下げ、実現可能性を検証する</td>
                  <td>Feasibility Filtersの適用、ステークホルダーインタビュー</td>
                  <td>検証済みの機会仮説</td>
                </tr>
                <tr>
                  <td>
                    <strong>Design（設計）</strong>
                  </td>
                  <td>ソリューションの形を具体化する</td>
                  <td>プロトタイピング、RAG/Fine-Tuning等の技術方式選定</td>
                  <td>AI-Native Value Blueprint</td>
                </tr>
                <tr>
                  <td>
                    <strong>Deliver（提供）</strong>
                  </td>
                  <td>本番運用に向けて実装・展開する</td>
                  <td>段階的ロールアウト、運用体制の確立、価値測定の開始</td>
                  <td>本番稼働・測定結果</td>
                </tr>
              </tbody>
            </table>
            ...
            <div className="diagram-wrap">
              ...
              <div className="diagram-caption">図6: AI-Native Solution Lifecycle</div>
            </div>
            ...
            <div className="callout source">
              ...
              <p>
                ...
                、
                <Ext href="https://scaledagile.com/certification/ai-native-value-architect/">
                  AI-Native Value Architect Certification（Scaled Agile公式、フェーズ名の記載元）
                </Ext>
              </p>
            </div>
            <div className="callout practice">
            ...
            <h3>5.4 Designフェーズのファシリテーション</h3>
            <div className="callout practice">
              <div className="callout-label">
                <IconBulb size={16} />
                ベストプラクティス
              ...
              <ul>
                <li>
                  Designフェーズのワークショップには、必ずビジネス側・技術側・エンドユーザー側の代表を同席させ、その場で認識合わせを行う。持ち帰っての非同期確認は誤解を長期化させやすい。
                </li>
              </ul>
            </div>

            <h3>5.5 コアアーティファクトの構築</h3>
            <p>Designフェーズを通じて、以下の3つの成果物を作成します。</p>
            <table>
              <thead>
                <tr>
                  <th>アーティファクト</th>
              ...
              <tbody>
                <tr>
                  <td>
                    <strong>AI-Native Solution Charter</strong>
                  </td>
                  <td>施策の目的・範囲・制約を関係者間で明文化する</td>
                  <td>目的、対象範囲、ステークホルダー、リスク境界、成功指標の初期案</td>
                </tr>
                <tr>
                  <td>
                    <strong>AI-Native Value Blueprint</strong>
                  </td>
                  <td>部門横断の合意形成された最終設計図</td>
                  <td>選定した技術方式（RAG/Fine-Tuning等）、運用体制、段階的ロールアウト計画</td>
                </tr>
                <tr>
                  <td>
                    <strong>実装計画（Implementation Plan）</strong>
                  </td>
                  <td>実行を加速するための具体的な計画</td>
                  <td>タイムライン、責任分担、依存関係、リスク対応計画</td>
                </tr>
              </tbody>
            </table>
            <div className="callout source">
          ...
          <section className="section" id="domain4">
            <h2>6. ドメイン4: Value Realization and Organizational Change（17–19%）</h2>
            ...
            <div className="callout practice">
              ...
              <ul>
                <li>
                  同じ結果でも、聞き手（経営層／現場マネージャー／エンドユーザー）に応じて伝え方を変える。経営層にはROIとリスク低減、現場マネージャーには業務プロセスへの影響、エンドユーザーには日々の作業がどう楽になるかを中心に伝える。
                </li>
                <li>
                  成功事例だけでなく、うまくいかなかった点とその学びも合わせて共有することで、次の投資判断への信頼性が高まる。
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="section" id="map">
            ...
            <div className="diagram-wrap">
              <div className="mermaid-target">
                <MermaidDiagram chart={DIAGRAM_INTEGRATION} />
              </div>
              <div className="diagram-caption">図7: AI Value Architectの全体統合マップ</div>
            </div>
            ...
            <ul>
              ...
              <li>
                <strong>Storytelling</strong>（第6章）は、成果を組織的な次の投資へとつなげる仕組み
              </li>
            </ul>
          </section>
          ...
          <section className="section" id="glossary">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>
                    <strong>ART (Agile Release Train)</strong>
                  </td>
                  <td>共通のミッションに向けて協調する複数のAgileチームの集合体</td>
                </tr>
                <tr>
                  <td>
                    <strong>AI-Native SAFe</strong>
                  </td>
                  <td>AI時代のガバナンスと役割定義を組み込んだ、SAFeの新しい運用モデル</td>
                </tr>
                <tr>
                  <td>
                    <strong>POC Graveyard</strong>
                  </td>
                  <td>試作（PoC）止まりで本番運用に至らないAI施策が滞留する状態の比喩表現</td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  <td>
                    <strong>Feasibility Filters</strong>
                  </td>
                  <td>AI施策の実現可能性をコーディング開始前に検証する一連の問い</td>
                </tr>
                <tr>
                  <td>
                    <strong>RAG (Retrieval-Augmented Generation)</strong>
                  </td>
                  <td>外部データを検索してプロンプトに追加することで、LLMの回答を補強する技術</td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>AI施策の目的・範囲・制約を関係者間で最初に明文化する文書</td>
                </tr>
                <tr>
                  <td>
                    <strong>AI-Native Value Blueprint</strong>
                  </td>
                  <td>技術方式・運用体制・展開計画を含む、部門横断合意済みの最終設計図</td>
                </tr>
                <tr>
                  <td>
                    <strong>RTE (Release Train Engineer)</strong>
                  </td>
                  <td>ARTのプロセス全体を回すサーバントリーダー</td>
                </tr>
                <tr>
                  <td>
                    <strong>SPC (SAFe Practice Consultant)</strong>
                  </td>
                  <td>組織へのSAFe導入・変革を支援するコンサルタント／トレーナー</td>
                </tr>
              </tbody>
            </table>
          </section>
            ...
            <div className="ref-list">
              <div className="ref-item">
                ...
                <div className="ref-body">
                  ...
                  <p className="ref-desc">認定資格の概要ページ</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  <Ext href="https://framework.scaledagile.com/ain-safe-ai-value-architect">
                    AI Value Architect（役割定義）
                  </Ext>
                  <p className="ref-desc">役割の公式定義</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  <Ext href="https://framework.scaledagile.com/blog/ai-native-safe-session-3-ai-native-teams-roles-and-arts">
                    AI-Native SAFe Session 3: AI-Native Teams, Roles, and ARTs
                  </Ext>
                  <p className="ref-desc">5つの責任領域の解説</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  <Ext href="https://ai-native-support.scaledagile.com/en/articles/16504256-exam-details-ai-native-value-architect-exam-ai-native-value-architect">
                    Exam Details: AI-Native Value Architect Exam
                  </Ext>
                  <p className="ref-desc">公式試験詳細・ドメイン構成</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  <Ext href="https://www.prnewswire.com/news-releases/scaled-agile-releases-ai-native-safe-a-new-version-of-the-worlds-most-trusted-framework-to-provide-governance-for-the-ai-era-302807369.html">
                    Scaled Agile Releases AI-Native SAFe（プレスリリース）
                  </Ext>
                  <p className="ref-desc">AI-Native SAFe全体像</p>
                </div>
              </div>
            </div>

            <h3>認定トレーニングパートナー（コース内容の裏付け）</h3>
            <div className="ref-list">
              <div className="ref-item">
                <span className="ref-num">6</span>
                <div className="ref-body">
                  <Ext href="https://www.cprime.com/learning/courses/ai-native-value-architect/">
                    AI-Native Value Architect（Cprime）
                  </Ext>
                  <p className="ref-desc">詳細なコースアウトライン</p>
                </div>
              </div>
              <div className="ref-item">
                <span className="ref-num">7</span>
                <div className="ref-body">
                  <Ext href="https://academy.capgemini.com/course/ai-native-value-architect-en">
                    AI-Native Value Architect（Capgemini Academy）
                  </Ext>
                  <p className="ref-desc">試験形式のクロスチェック</p>
                </div>
              </div>
              <div className="ref-item">
                <span className="ref-num">8</span>
                <div className="ref-body">
                  <Ext href="https://prettyagile.com.au/course/ai-native-value-architect">
                    AI-Native Value Architect（Pretty Agile）
                  </Ext>
                  <p className="ref-desc">試験形式のクロスチェック</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  <Ext href="https://www.gladwellacademy.com/knowledge/blogs/what-is-an-ai-value-architect">
                    What is an AI Value Architect? Role &amp; Skills（Gladwell Academy）
                  </Ext>
                  <p className="ref-desc">5つの責任領域の第三者要約</p>
                </div>
              </div>
            </div>
            ...
            <div className="ref-list">
              ...
              <div className="ref-item">
                ...
                <div className="ref-body">
                  ...
                  <p className="ref-desc">経営層のAI習熟度に関するGartner調査</p>
                </div>
              </div>
            </div>

            <h3>技術解説記事（RAG vs Fine-Tuning、ガバナンス）</h3>
            <div className="ref-list">
              <div className="ref-item">
                ...
                <div className="ref-body">
                  ...
                  <p className="ref-desc">コスト構造の詳細分析</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  ...
                  <p className="ref-desc">2026年時点の意思決定フレームワーク</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  ...
                  <p className="ref-desc">実務者による判断マトリクス</p>
                </div>
              </div>
              <div className="ref-item">
                ...
                <div className="ref-body">
                  ...
                  <p className="ref-desc">AIガバナンスの公的フレームワーク</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <footer className="footer">
            本ガイドは学習目的で作成された非公式資料であり、Scaled Agile, Inc.
            の公式教材・著作物を複製したものではありません。試験内容・出題比率・料金体系は変更される可能性があるため、受験前に必ず公式サイトで最新情報をご確認ください。
          </footer>
        </main>
      </div>
    </div>
