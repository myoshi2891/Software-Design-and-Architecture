    ...
    def start(self):
        ...
        <section id="s6">
          ...
          <div className="mermaid-wrap">
            ...
            <div className="diagram-caption">図6-1: APIゲートウェイのアーキテクチャと機能一覧</div>
          </div>
          ...
          <div className="co co-green">
            ...
            <div className="cb">
              ...
              <ul>
                ...
                <li>
                  <strong>PodDisruptionBudget を設定：</strong>ノードメンテナンス時に最低Pod数を保証
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="co co-green">
            ...
            <div className="cb">
              ...
              <ul>
                ...
                <li>
                  <strong>リトライ：</strong>指数バックオフ + ジッター追加で同時リトライを分散させる
                </li>
                <li>
    ...
    return {"deleted": order_id}`,
          ...
          <div className="co co-red">
            ...
            <div className="cb">
              ...
              <ul>
                <li>
                  <strong>mTLS：</strong>サービス間通信はすべて相互TLS認証（Istio/Linkerd で自動化）
                </li>
                <li>
          ...
          <div className="co co-blue">
            ...
            <div className="cb">
              ...
              <ul>
                ...
                <li>
                  <strong>Namespace で環境分離：</strong>staging/production を別Namespaceで管理する
                </li>
                <li>
    ...
    async def create_order(self, customer_id: str, items: list) -> dict:
        ...
        <section id="s17">
          ...
          <div className="co co-red">
            ...
            <div className="cb">
              ...
              <p>
                <strong>原因：</strong>「小さいほど良い」という誤解。機能ではなく操作単位での分割。
              </p>
              <p>
                <strong>解決：</strong>
        ...
        <section id="s18">
          ...
          <div className="rg">
            ...
            <Ext className="ri" href="https://martinfowler.com/bliki/StranglerFigApplication.html">
              <div className="ri-ic">🌳</div>
              <div className="ri-body">
            ...
            >
              ...
              <div className="ri-body">
                ...
                <div className="ri-u">microservices.io/patterns/data/database-per-service.html</div>
