      ...
      <div className="layout">
        ...
        <main className="main">
          ...
          <article>
            ...
            <p>
              ご提示いただいた O'Reilly のページ（
              <code>
                https://www.oreilly.com/library/view/designing-with-multi-agent/9783110797473/
              </code>
              ）は、Evangelos Pantazis 著・De Gruyter 刊『
              <em>Designing with Multi-Agent Systems</em>
              』（2024年2月刊）でした。実際に内容を確認したところ、この書籍は
              <strong>建築・エンジニアリング・建設（AEC）分野</strong>
              において、ファサード設計やシェル構造設計などの初期設計段階にマルチエージェントシステム（群知能によるボトムアップ的な形態生成）を応用する研究書であり、ソフトウェア/AIエンジニアリングにおける「LLMエージェントを複数連携させるシステム設計」とは主題が異なります。
            </p>
            <p>
              そのため本ガイドでは、書籍の章構成をなぞるのではなく、
              <strong>
