...
const NAV_GROUPS: readonly NavGroup[] = [
  ...
  {
    title: "第1部（Ch1）：プロトタイプを構築する",
    items: [
      {
        id: "part1",
        label: "第1部（Ch1）：プロトタイプを構築する",
      },
      {
  ...
  {
    title: "第2部（Ch2）：生成AIアプリケーションを評価する",
    items: [
      {
        id: "part2",
        label: "第2部（Ch2）：生成AIアプリケーションを評価する",
      },
      {
  ...
  {
    title: "第3部（Ch3）：主要アーキテクチャを理解する",
    items: [
      {
        id: "part3",
        label: "第3部（Ch3）：主要アーキテクチャを理解する",
      },
      {
  ...
  {
    title: "第4部（Ch4）：プロトタイプから本番コードへ",
    items: [
      {
        id: "part4",
        label: "第4部（Ch4）：プロトタイプから本番コードへ",
      },
      {
  ...
  {
    title: "第5部（Ch5）：DevOps・MLOpsからLLMOpsへ",
    items: [
      {
        id: "part5",
        label: "第5部（Ch5）：DevOps・MLOpsからLLMOpsへ",
      },
      {
  ...
  {
    title: "第6部（Ch6）：アプリケーションをデプロイする",
    items: [
      {
        id: "part6",
        label: "第6部（Ch6）：アプリケーションをデプロイする",
      },
      {
  ...
  {
    title: "第7部（Ch7）：倫理とセキュリティ",
    items: [
      {
        id: "part7",
        label: "第7部（Ch7）：倫理とセキュリティ",
      },
      {
  ...
  {
    title: "第8部（Ch8）：可観測性と信頼性",
    items: [
      {
        id: "part8",
        label: "第8部（Ch8）：可観測性と信頼性",
      },
      {
  ...
  {
    title: "第9部（Ch9）：アプリケーションを保守する",
    items: [
      {
        id: "part9",
        label: "第9部（Ch9）：アプリケーションを保守する",
      },
      {
  ...
  {
    title: "第10部（Ch10）：A/Bテストとオンライン実験",
    items: [
      {
        id: "part10",
        label: "第10部（Ch10）：A/Bテストとオンライン実験",
      },
      {
        id: "101-abテストとは何か",
    ...
    <div className="architecting-generative-ai-applications-guide">
      <div className="layout">
        ...
        <main className="main">
          ...
          <h2 id="part1">第1部（Ch1）：プロトタイプを構築する</h2>
          ...
          <h2 id="part2">第2部（Ch2）：生成AIアプリケーションを評価する</h2>
          ...
          <h2 id="part3">第3部（Ch3）：主要アーキテクチャを理解する</h2>
          ...
          <h2 id="part4">第4部（Ch4）：プロトタイプから本番コードへ</h2>
          ...
          <h2 id="part5">第5部（Ch5）：DevOps・MLOpsからLLMOpsへ</h2>
          ...
          <h2 id="part6">第6部（Ch6）：アプリケーションをデプロイする</h2>
          ...
          <h2 id="part7">第7部（Ch7）：倫理とセキュリティ</h2>
          ...
          <h2 id="part8">第8部（Ch8）：可観測性と信頼性</h2>
          ...
          <h2 id="part9">第9部（Ch9）：アプリケーションを保守する</h2>
          ...
          <h2 id="part10">第10部（Ch10）：A/Bテストとオンライン実験</h2>
